...
export default class AttendanceAdd extends Component{
    ...
    constructor(props) {
      ...
      componentDidMount() {
        axios.get('https://web-msrit-backend.herokuapp.com/student')
          .then(response => {
      ...
      componentDidMount() {
        axios.get('https://web-msrit-backend.herokuapp.com/classes')
          .then(response => {
            if (response.data.length > 0) {
              this.setState({
      ...
      onSubmit(e) {
        ...
        axios.post('https://web-msrit-backend.herokuapp.com/attendance/add', attendance)
